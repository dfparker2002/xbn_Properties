...
Functionality: **_Consuming a basic properties file in a camel project._**
...
Git clone the xbn_Properties project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbn_Properties.git
cd xbn_Properties
mvn install -DskipTests

```

You man now import xbn_Properties into your IDE.
...
_Run XbnTest. Also see NOTES.md_
